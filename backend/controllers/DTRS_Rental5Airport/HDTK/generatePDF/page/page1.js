    ...
    if (
      ...
      const image_row1_col1 = await document.embedJpg(
        fs.readFileSync(
          path.join(
            process.cwd(),
            `/model/DTRS_Rental5Airport/HDTK/generatePDF/uploaded/images/${import_pdf.sumImagePDF.image1}`
          )
        )
      );
    ...
    if (
      ...
      const image_row1_col2 = await document.embedJpg(
        fs.readFileSync(
          path.join(
            process.cwd(),
            `/model/DTRS_Rental5Airport/HDTK/generatePDF/uploaded/images/${import_pdf.sumImagePDF.image2}`
          )
        )
      );
    ...
    if (
      ...
      const image_row2_col1 = await document.embedJpg(
        fs.readFileSync(
          path.join(
            process.cwd(),
            `/model/DTRS_Rental5Airport/HDTK/generatePDF/uploaded/images/${import_pdf.sumImagePDF.image3}`
          )
        )
      );
    ...
    if (
      ...
      const image_row2_col2 = await document.embedJpg(
        fs.readFileSync(
          path.join(
            process.cwd(),
            `/model/DTRS_Rental5Airport/HDTK/generatePDF/uploaded/images/${import_pdf.sumImagePDF.image4}`
          )
        )
      );
    ...
    if (
      ...
      const image_row3_col1 = await document.embedJpg(
        fs.readFileSync(
          path.join(
            process.cwd(),
            `/model/DTRS_Rental5Airport/HDTK/generatePDF/uploaded/images/${import_pdf.sumImagePDF.image5}`
          )
        )
      );
    ...
    if (
      ...
      const image_row3_col2 = await document.embedJpg(
        fs.readFileSync(
          path.join(
            process.cwd(),
            `/model/DTRS_Rental5Airport/HDTK/generatePDF/uploaded/images/${import_pdf.sumImagePDF.image6}`
          )
        )
      );
