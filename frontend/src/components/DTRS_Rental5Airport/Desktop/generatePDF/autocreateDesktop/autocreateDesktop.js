              ...
              <div className="box box-info">
                <div className="box-header">
                  ...
                  <h3 className="box-title">
                    ระบบสร้างไฟล์ PDF สำหรับ Report Desktop อัตโนมัติ
                  </h3>
      ...
      <Formik
        ...
        onSubmit={async (values, { setSubmitting }) => {
          ...
          let checkStatusCode = await httpClient.post(
            server.API_GENERATEPDF_DTRS_RENTAL5AIRPORT_DESKTOP_AUTOCREATE_URL,
            formData
          );
...
export default AutocreateDesktop;
