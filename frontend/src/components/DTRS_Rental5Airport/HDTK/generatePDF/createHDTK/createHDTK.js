      ...
      <div className="content-wrapper">
        <section className="content-header">
          ...
          <ol className="breadcrumb">
            ...
            <li className="active">สร้างไฟล์ PDF สำหรับ Report HDTK</li>
          </ol>
        </section>
              ...
              <div className="box box-info">
                <div className="box-header">
                  ...
                  <h3 className="box-title">
                    ฟอร์มสร้างไฟล์ PDF สำหรับ Report HDTK
                  </h3>
                ...
                <div className="box-header">
                  <a
                    href="/home/generatePDF/dtrs_rental5airport/hdtk/autocreate"
    ...
    <Formik
      ...
      onSubmit={async (values, { setSubmitting }) => {
        ...
        let checkStatusCode = await httpClient.post(
          server.API_GENERATEPDF_DTRS_RENTAL5AIRPORT_HDTK_CREATE_URL,
          formData
        );
